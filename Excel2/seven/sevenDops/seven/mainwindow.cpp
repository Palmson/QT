...
void MainWindow::on_pushButton_find_clicked()
{
    ...
    if(isCorrectValues())//если все значения подходят
    {
        ...
        x1= itemX1->text().toInt();
        xn= itemXn->text().toInt();
        y1= itemY1->text().toInt();
        yn= itemYn->text().toInt();
        double res1=xn*y1;
        double res2=x1*yn;
        S+=res1;
        S-=res2;
        ...
        {
            int x1= ui->tableWidget_massive->item(i,0)->text().toInt();
            int y1= ui->tableWidget_massive->item(i,1)->text().toInt();
            int x2= ui->tableWidget_massive->item(i+1,0)->text().toInt();
            int y2= ui->tableWidget_massive->item(i+1,1)->text().toInt();

            double leng = sqrt(pow(x2-x1,2)+pow(y2=y1,2));
            P+=leng;
        }
        x1=ui->tableWidget_massive->item(0,0)->text().toInt();
        y1=ui->tableWidget_massive->item(0,1)->text().toInt();
        int x2=ui->tableWidget_massive->item(size-1,0)->text().toInt();
        int y2=ui->tableWidget_massive->item(size-1,1)->text().toInt();
