...
private slots:
    ...
    double lengthBetweenPoints(double x1, double y1, double x2, double y2);
...
private:
    ...
    QVector <double> x,y,opr,length; //создаём динамические массивы для хранения: координат X и Y, определителей, длин векторов - с помощью QVector
};
